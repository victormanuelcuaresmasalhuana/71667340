...
-- Last modification date: 2023-05-16 02:47:03.802
...
CREATE TABLE Docente (
    ...
    celular char(9)  NOT NULL COMMENT 'Contiene los Numeros de Celulares de los docentes.',
    direccion varchar(90)  NOT NULL COMMENT 'Contiene los datos de direcciones de los docentes.',
...
CREATE TABLE Estudiante (
    ...
    Apoderado_dni char(8)  NOT NULL COMMENT 'Contiene los datos del apoderado y DNI.',
    CONSTRAINT Estudiante_pk PRIMARY KEY (dni)
) COMMENT 'Contiene los Datos de los estudiantes.';

-- Table: Grado
CREATE TABLE Grado (
    codigo_aula char(10)  NOT NULL COMMENT 'Contiene los datos de el codigo del Aula',
